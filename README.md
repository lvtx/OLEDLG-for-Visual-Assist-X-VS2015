# OLEDLG for Visual Assist X-[VS2015]

#### 软件作者
软件作者：lvtx

#### 软件介绍
[VS2015] OLEDLG for Visual Assist X 通用破解补丁

#### 使用说明

1. 本补丁程序是使用 VS2015 编写和编译出来的，原理是利用 OLEDLG.dll API 劫持 VA_X.dll 来实现替换 Visual Assist X 的注册 Public Key，从而可以使用 DoubleLabyrinth 老大以前发布过的 [VisualAssist-keygen-demo](https://github.com/DoubleLabyrinth/VisualAssist-keygen-demo.git) 来算出属于自己的注册码。
